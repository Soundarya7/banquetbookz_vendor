...
final textFieldStateProvider = StateNotifierProvider<TextFieldStateNotifier, List<bool>>((ref) {
  return TextFieldStateNotifier(11); // Initialize with the number of text fields
});
